...
class ChatLog
{
     ...
     * @return array|null
     */
    public function getHistoryAsArray($in_limit = 5)
    {
    ...
    // Setter-Methoden
    public function setUserId($in_user_id)   { $this->user_id = $in_user_id; }
    public function setMsg($in_msg)           { $this->msg = $in_msg; }
    public function setMsgType($in_msg_type) { $this->msg_type = $in_msg_type; }

    // Getter-Methoden
    public function getMsg()        { return $this->msg; }
    public function getMsgType()   { return $this->msg_type; }
